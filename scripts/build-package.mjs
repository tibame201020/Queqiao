...
const internalPackages = new Map(["audit", "config", "contracts", "core-manifest", "mcp-compat", "operations", "platform-paths", "policy", "process-runtime", "protocol", "security", "tool-runtime", "worker-protocol", "workspace"].map((name) => [`@queqiao/${name}`, path.resolve(`packages/${name}/src/index.ts`)]));
