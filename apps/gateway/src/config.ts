...
export type GatewayRuntimeConfig = { host?: "127.0.0.1"; port: number; managementPort: number; publicBaseUrl: URL; resourceUrl: string; stateDir: string; approvalSecret: string; jwtSecret: Uint8Array; trustProxyHops: number; allowedRedirectOrigins: Set<string>; workers: readonly WorkerEndpointConfig[]; workersFile?: string; extensions: readonly InstalledExtensionConfig[]; configDirectory: string };
