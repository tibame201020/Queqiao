...
export type GatewayRuntimeConfig = { port: number; publicBaseUrl: URL; resourceUrl: string; stateDir: string; approvalSecret: string; jwtSecret: Uint8Array; trustProxyHops: number; allowedRedirectOrigins: Set<string>; workers: readonly WorkerEndpointConfig[]; workersFile?: string; extensions: readonly InstalledExtensionConfig[]; configDirectory: string };
