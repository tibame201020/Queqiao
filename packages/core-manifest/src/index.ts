...
export const CORE_PUBLIC_TOOL_CONTRACTS = {
  ...
  open_workspace: {
    ...
    inputSchema: z.object({ workspaceId: z.string().min(1).max(64) }), requiredCapabilities: ["workspace:read"], risk: "read", annotations: readAnnotations,
  },
  write_file: {
